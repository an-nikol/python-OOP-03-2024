...
from project_1.climbers.arctic_climber import ArcticClimber
from project_1.climbers.summit_climber import SummitClimber
from project_1.peaks.arctic_peak import ArcticPeak
from project_1.peaks.summit_peak import SummitPeak
...
class SummitQuestManagerApp:
    ...
    def get_statistics(self):
        ...
        for c in self.climbers:
            #  filter the climbers who have conquered peaks
            if c.conquered_peaks:
                # sort each climbers conquered peaks
                c.sort_conquered_peaks()
                # add the climber in the new list of climbers who have conquered
